...
**D2 — Masked reference format `<first6>…<last4>`**, consistent with existing logger redaction; enough for human triage ("which key is this"), useless for reconstruction.
